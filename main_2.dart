...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    mqttConnect();
    mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ledOff");
  }
              ...
              Row(
                ...
                children: [
                  Container(
                      ...
                      child: StreamBuilder(
                        stream: mqttSubscribe('jb/shilmu/csle/smenco/mdlp/dht'),
                        builder:
                  ...
                  Padding(
                      ...
                      child: LiteRollingSwitch(
                        ...
                        onChanged: (bool position) {
                          ...
                          if (position) {
                            mqttPublish(
                                "jb/shilmu/csle/smenco/mdlp/neo", "ledOn");
                            ledOnToast();
                            ledCtrl = "on";
                          } else {
                            mqttPublish(
                                "jb/shilmu/csle/smenco/mdlp/neo", "ledOff");
                            ledOffToast();
                            ledCtrl = "off";
                          }
                        },
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ylw1");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ylw2");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ylw3");
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "grn1");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "grn2");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "grn3");
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      debugPrint('BLUE 1단계');
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "blu1");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      debugPrint('BLUE 2단계');
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "blu2");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      debugPrint('BLUE 3단계');
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "blu3");
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ppl1");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ppl2");
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (ledCtrl == "on") {
                        mqttPublish("jb/shilmu/csle/smenco/mdlp/neo", "ppl3");
